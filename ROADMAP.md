...
- [x] Add `--format=table|csv|json|kv` to release.sh and check-evolve-state.sh (Day 17)
- [x] Add migrate.sh detection for release.sh and check-evolve-state.sh --format flags (Day 17)
- [x] Add integration tests for release.sh and check-evolve-state.sh --format (Day 17)
